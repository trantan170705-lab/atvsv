...
Ứng dụng web chuyên dụng dành cho **người không chuyên âm thanh**, điều khiển 4 hiệu lệnh kịch bản và 1 nhạc dự phòng theo sân khấu trực tiếp chỉ với **1 phím SPACE**.
...
| **04** | Sau lời Chị chủ nhà, trước câu “Vậy thôi mình đi tiếp...” | <kbd>SPACE</kbd> | Sấm chớp ngắn, tự tắt. |
| **05.1** | Cán bộ An toàn bước ra giữa sân khấu | <kbd>SPACE</kbd> | 28% (Nhạc nền nhẹ, không át lời thoại) |
| **05.2** | Dứt câu *"...chúng tôi mang đến thông điệp:"* | <kbd>SPACE</kbd> | 28% ➔ 48% (Ramp 1.2s, giữ 48% khi hô khẩu hiệu) |
| **05.3** | Dứt chữ *"PHỤC VỤ!"* khi hô xong | <kbd>SPACE</kbd> | 48% ➔ 72% (Hold 1.8s ➔ Fade out 2.8s ➔ Tự động hoàn thành) |

---

## 📊 3. Tỷ Lệ Âm Lượng Tương Đối Chuẩn (Gain Levels)

* **Nhạc nền thông điệp (Lệnh 05.1)**: `28%`
* **Nhạc cao trào trước hô (Lệnh 05.2)**: `48%`
* **Nhạc dọn sân khấu (Lệnh 00)**: `55%`
* **Tiếng chó sủa (Lệnh 01)**: `72%`
* **Sấm chớp (Lệnh 04)**: `65%`
* **Đỉnh nhạc kết (Lệnh 05.3)**: `72%`
...
| Phím Tắt | Chức Năng |
| :---: | :--- |
| <kbd>SPACE</kbd> | **PHÁT LỆNH / CAO TRÀO**: Phát lệnh âm thanh hiện tại hoặc đẩy cao trào nhạc kết (Lệnh 05). |
| <kbd>F</kbd> | **GIẢM NHỎ & DỪNG**: Giảm nhỏ âm lượng mượt mà rồi dừng (dành cho Lệnh 00 và Lệnh 05). |
...
3. **Bước 3**: Kiểm tra thông báo **5/5 ÂM THANH ĐÃ NẠP – SẴN SÀNG**.
